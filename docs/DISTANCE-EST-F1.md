...
> **v4 far polish (2026-09-24 ~14:07 ET, branch `frontier/tip-distance-far`):** GP-heavy far 100–200 m + finer parallax/EMA. Far-set MAE **4.653→2.600 m**; original far 5.440→4.563; danger50 far 6.121→2.684. DZ + mid held 100%. Side-only — not folded. See `docs/FRONTIER-CODIGO-VIVO-TIP-DISTANCE-FAR.md`.
