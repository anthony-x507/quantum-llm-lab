...
**Fold feat:** `9f3ca74` (cherry-pick `d9528bf` onto `9f2afbc`)  
**Doc:** `docs/FRONTIER-CODIGO-VIVO-TIP-R20.md`

| Surface | Result |
|---------|--------|
| R20 router / verifier | **7→52/52** / **44/44** (side 6→52; post retained **100%**; tip-local rise_ret ~97.8%; side rise_pp **88.46** ≥80) |
| R19 / R18 | **52/52·44/44** / **52/52·44/44** |
| pillars / hardneg smoke / circ | **37/37 · 18/18 · 5/5** |
| mixed (d) unified | **1.0** |
| choose_n80 / tti-cold | **100%** / **~95%** freeze retained |

**CPU re-smoke after fold:** R20 7→52; R19/R18/pillars/circ/mixed floors held; choose_n + tti-cold freezes retained; freezes retained incl. r19 + r18 + r17 + tti_cold_fold + r16 + choose_safest_n_fold + r15 + r14 + LP + pillars + circ + future_r3 + side polish_r20. Adapters RO. R21+ not folded.

**Method:** cherry-pick `d9528bf` onto tip `9f2afbc`; merge R12+R13+R14+R15+R16+R17+R18+R19+R20 gates_ops; keep tip STATUS+mixed/LP/r7–r12 JSON ours.

**Not folded:** R21+ @ side tip-hardneg-r21… 

---

## Fold — tip-hardneg-r19 → codigo-vivo-tip (2026-09-24 15:48:57 ET)
...
| Surface | Result |
|---------|--------|
| R19 router / verifier | **18→52/52** / **44/44** (side 6→52; post retained **100%**; tip-local rise_ret ~73.9%; side rise_pp **88.46** ≥80) |
...
**CPU re-smoke after fold:** R19 18→52; R18/R17/pillars/circ/mixed floors held; choose_n + tti-cold freezes retained; freezes retained incl. r18 + r17 + tti_cold_fold + r16 + choose_safest_n_fold + r15 + r14 + LP + pillars + circ + future_r3 + side polish_r19. Adapters RO. R20+ not folded.

**Method:** cherry-pick `f20e327` onto tip `9c320cb`; merge R12+R13+R14+R15+R16+R17+R18+R19 gates_ops; keep tip STATUS+mixed/LP/r7–r12 JSON ours.

**Not folded:** R20 @ `8cad9b3` → … → R29.
...
**Side:** `970fc4a` / feat `297fba1` · **Base tip:** `a54b74c` (post tti-cold)  
**Freeze:** `codigo_vivo_tip_r17_100pct_20260924_153921`  
**Fold SHA:** 40f2c69  
**Doc:** `docs/FRONTIER-CODIGO-VIVO-TIP-R17.md`

| Surface | Result |
|---------|--------|
| R17 router / verifier | **8→52/52** / **44/44** (side 8→52; rise retained **100%**) |
| R16 / R15 / LP | **52/52·44/44 · 52/52 · 64/64·42/42** |
| mixed (d) unified | **1.0** |
| pillars / circ / choose_n80 | **37/37 · 5/5 · 100%** |
| tti-cold freeze | **~95%** retained (no residual chase) |

**CPU re-smoke after fold:** R17 8→52; R16/R15/LP/pillars/circ/mixed floors held; choose_n + tti-cold freezes retained; freezes retained incl. tti_cold_fold + r16 + choose_safest_n_fold + r15 + r14 + LP + pillars + circ + future_r3 + side polish_r17. Adapters RO. R18+ not folded.

**Method:** cherry-pick `297fba1` onto tip `a54b74c`; merge R12+R13+R14+R15+R16+R17 gates_ops; keep tip STATUS+mixed/LP/r7–r12 JSON ours.

**Not folded:** R18 @ `1be50d2` → … → R27.
...
**When:** polish side ~14:15–14:18 ET · fold 2026-09-24 15:08:09 ET · Mac-111 · cherry-pick `37ccc6f`/`1191a24` onto `1d5fe3e` → `e1b12d5` / fold `6a4e716`  
...
|---------|-------|
| mixed (d) unified | **1.0** |
| LP router (before→after) | **43/43 → 64/64** |
| LP verifier (before→after) | **32/32 → 42/42** |
| side trail | 43→64 · 32→42 |
| pillars · hardneg smoke | **37/37 · 18/18** retained |
...
**CPU/smoke re-smoke after fold:** LP **64/64 · 42/42**; pillars **37/37** · hardneg **18/18**; unified **1.0**; R13 **52/52**; circ **5/5** retained; floors retained; `wired_to_vlm=true`; tip vis BASE.  
Anti-contam **CLEAN**. Adapters RO unchanged. Freezes retained incl. pillars_reinforce_fold + circ_expand_fold + future_track_r3 + r13 + distance_far + inverse_r3 + r12 + mid + tti + r11 + motion_r4 + vision_ground + side label_protect_expand. Never abandon.

**Not folded:** R14+ @ 1191a24 → R15 → choose-n → R16 → tti-cold → R17…R23.
...
|---------|-------|
| mixed (d) unified | **1.0** |
| far 100–200 m MAE | **4.653→2.600 m** (100% 1053/1053) |
| DZ 30–70 · mid near/outer | **100% · 100%** (orig 527/527 · d50 915/915 · mid 55/55 · 684/684·374/374) |
| TTI scorable | **100%** (691/691 · 725/725) |
| inverse_cv · collision · choose_safest | **100% · 100% · 100%** (n=40 / 2850) |
| R12 router · verifier | **52/52 · 44/44** (retained) |
| pillars / hardneg smoke | **26/26 · 18/18** |
...
**CPU re-smoke after fold:** unified **1.0**; far MAE **2.600 m**; DZ/mid **100%**; TTI **100%**; inv_cv **100%**; collision+choose_safest **100%**; R12 **52/52·44/44**; pillars 26/26; hardneg 18/18; `wired_to_vlm=true`; tip vis BASE.  
Anti-contam **CLEAN**. Adapters RO unchanged. Freezes retained incl. inverse_r3 + r12 + distance_mid + tti + r11 + motion_r4 + vision_ground + inverse_r2 + r10 + priors. Never abandon.

**Not folded:** hardneg-r13 / circ-expand / future-track.
...
**Frozen SHA:** `f0a8c94dc2c53c161aeb7192dcb8c18f615ee563` (`f0a8c94`) · branch `frontier/codigo-vivo-tip` · cherry-pick rebase `6bb06fc`/`8764220` onto `f70faa1` → `4629919`+`e472522` FF-equivalent then fold
...
**Frozen SHA:** `2045645a6eff7b2a946adbf9638083a5c47dfde3` (`2045645`) · branch `frontier/codigo-vivo-tip` · rebase `a59cb7a`/`606c66f` onto `3f5f1b1` → `753b1f7`+`a27b6fd` FF then fold
...
| Metrics | `data/freeze_metrics/codigo_vivo_tip_vision_ground_20260924.json` |
| Fold metrics | `data/freeze_metrics/codigo_vivo_tip_vision_ground_fold_20260924.json` |
| Vision-ground doc | `docs/FRONTIER-CODIGO-VIVO-TIP-VISION-GROUND.md` |
| Re-smoke | PASS · vision BASE 1.000 · circ 2/2 · inverse_cv 99.82% · collision 100% · choose_safest 100% · R10 52/52·44/44 · motion 97.5% · cpu overall 1.0 |
