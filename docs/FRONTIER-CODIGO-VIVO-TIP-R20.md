...
**Branch:** `frontier/tip-hardneg-r20` (side; not folded)  
...
- Do **not** touch tip-cv, tip-tti*, tip-distance-*, tip-hardneg-r12..r19, tip-inverse*, tip-circ*, tip-future*, tip-choose*, tip-pillars*, tip-lp* (other lanes / fold queue). R20 stays side-only. **Do NOT fold.**
...
Leave tip-cv / tip-tti* / tip-distance-* / tip-hardneg-r12..r19 / tip-inverse* / tip-circ* / tip-future* / tip-choose* / tip-pillars* alone (fold queue future-r3→circ→pillars→R14→R15→choose-n→R16→tti-cold→R17→R18→R19). Side branch only. **Do NOT fold.**
