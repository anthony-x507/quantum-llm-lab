...
**Branch:** `frontier/tip-hardneg-r19` (side; not folded)  
...
Leave tip-cv / tip-tti* / tip-distance-* / tip-hardneg-r12..r18 / tip-inverse-r3 / tip-circ-expand / tip-future-track* / tip-choose-safest-n / tip-pillars* alone (fold queue R13→future-r3→circ→R14→R15→choose-n→R16→tti-cold→R17→R18). Side branch only. **Do NOT fold.**
