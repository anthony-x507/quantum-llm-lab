## 2026-09-24 — tip-tti-cold (side FREEZE, not folded)
Branch `frontier/tip-tti-cold` from tip `4bfc924`. Soft class closing-speed priors + motion_hint cold TTI. TTI scorable **100%** held (691/691 · 725/725); overall+cold **91.16→94.99** / **91.66→94.82**; distance DZ **100%**; collision physics/inverse_cv/choose_safest **100%** (n=2850); motion untouched (tip 100%). Anti-contam CLEAN. Freeze `codigo_vivo_tip_tti_cold_100pct_20260924_143601`. **Not folded.** RO `data/lora_adapter/`. See `docs/FRONTIER-CODIGO-VIVO-TIP-TTI-COLD.md`.
