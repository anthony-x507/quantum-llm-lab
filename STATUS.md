...
## 2026-09-24 — tip-tti (side) TTI metric 0→100% scorable
Branch `frontier/tip-tti` @ worktree tip-tti. Base `9cc5ed5`. TTI primary **100%** (orig 691/691 · danger50 725/725); overall+cold-start 91.16/91.66; distance 100% held; collision physics **100%** · inverse_cv **99.82%** · choose_safest **100%**; mixed **1.0** assumed; contam PASS; adapters RO; freeze `codigo_vivo_tip_tti_100pct_20260924_135659`. Fold pending on tip-cv. See `docs/FRONTIER-CODIGO-VIVO-TIP-TTI.md`.
