...
## 2026-09-24 — tip-distance-mid (5–30 / 70–100 outside frozen DZ)
Branch `frontier/tip-distance-mid` from tip `fabef2b` (avoid inverse-r2); rebased onto tip post-TTI `e0f3183`. Mid focused set 96 seq; mid_near/outer **100%** tol; outer MAE 2.081→1.624 m; **DZ 30–70 held 100%** (orig/danger50/mid). Anti-contam CLEAN. Adapters RO. Freeze `codigo_vivo_tip_distance_mid_100pct`. Fold pending on tip-cv. See `docs/FRONTIER-CODIGO-VIVO-TIP-DISTANCE-MID.md`.
