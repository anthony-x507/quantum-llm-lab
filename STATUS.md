## 2026-09-24 — tip-hardneg-r18 polish (side; NOT folded)
Branch `frontier/tip-hardneg-r18` from tip `5fb00e3` (post distance-far; ≥ `34c696f`). R18 router **52/52** · verifier **44/44**; mixed (d) **1.0**; R7–R12+LP held; `ent_never_on_python`. Novel: AWS ALB / Azure Front Door / GCP URL Map / Apache Hudi / Iceberg / Flink / NiFi / Concourse / Woodpecker / TeamCity / Cargo / Go build tags / Quarkus / Micronaut. Rise +88.46 pp ≥80% → freeze polish_r18. Adapters RO. See `docs/FRONTIER-CODIGO-VIVO-TIP-R18.md`.
