## 2026-09-24 — tip-hardneg-r17 polish (side; NOT folded)
Branch `frontier/tip-hardneg-r17` from tip `34c696f` (post inverse-r3 fold). R17 router **52/52** · verifier **44/44**; mixed (d) **1.0**; R2–R12+LP held; `ent_never_on_python`. Novel: Cloudflare Worker / CloudFront / Vitess / CockroachDB / Pinot / CircleCI / Drone / Maven / sbt / Rails / Phoenix / Flagger / Argo Rollouts / Debezium. Rise +84.62 pp ≥80% → freeze polish_r17. Adapters RO. See `docs/FRONTIER-CODIGO-VIVO-TIP-R17.md`.
