## 2026-09-24 — tip-hardneg-r29 polish (side; NOT folded)
Branch `frontier/tip-hardneg-r29` from tip `a54b74c` (post tti-cold fold; ≥677235a). R29 router **6→52/52** · verifier **44/44**; mixed (d) **1.0**; R7–R14+LP held; `ent_never_on_python`. Novel: Bookshelf.js / Objection.js / MikroORM / Tornado / Bottle / Falcon / Pyramid / Echo / Chi / Hanami / Resque / RQ / BlackSheep / Taskiq (brief-suggested swaps for tip-brand + R9–R28 collisions). Rise **+88.46 pp** → freeze polish_r29 100%. See `docs/FRONTIER-CODIGO-VIVO-TIP-R29.md`.
