## 2026-09-24 — tip-hardneg-r15 polish (side; not folded)
Branch `frontier/tip-hardneg-r15` from tip `e0f3183` (post tip-tti). R15 router **6/52→52/52** · verifier **44/44**; mixed (d) **1.0**; R1–R11+LP held; motion **100%** / TTI **100%** / collision **100%** / inverse_cv **≥99.82%** cited from tip. Novel: Squid / OpenResty / Contour / Emissary / Zuul / Django / Laravel / Gin / DynamoDB / Firestore / Keycloak / Falco / OTel / Ray. See `docs/FRONTIER-CODIGO-VIVO-TIP-R15.md`. **Not folded.**
