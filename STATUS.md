## 2026-09-24 — tip-hardneg-r27 polish (side; NOT folded)
Branch `frontier/tip-hardneg-r27` from tip `88287bc` (post choose-safest-n fold; ≥422a9e3). R27 router **6→52/52** · verifier **44/44**; mixed (d) **1.0**; R7–R14+LP held; `ent_never_on_python`. Novel: Sequelize / Mongoose / Actix / Rocket / Diesel / GORM / Fastify / Hapi / Sanic / Starlette / Sidekiq / Dramatiq / Dropwizard / Ktor (brief-suggested swaps for tip-brand + R9–R26 collisions). Rise **+88.46 pp** → freeze polish_r27 100%. See `docs/FRONTIER-CODIGO-VIVO-TIP-R27.md`.
