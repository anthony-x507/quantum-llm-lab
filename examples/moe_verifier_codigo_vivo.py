    ...
    if out_path is None:
        if mode.startswith("replay"):
            ...
            if 'label_protect' in hp or 'label-protect' in hp:
                ...
                out_path = ROOT / "data" / "frontier_moe_verifier_hardneg_r21.json"
            elif 'r20' in hp:
                out_path = ROOT / "data" / "frontier_moe_verifier_hardneg_r20.json"
            elif 'r19' in hp:
                out_path = ROOT / "data" / "frontier_moe_verifier_hardneg_r19.json"
            elif 'r18' in hp:
                out_path = ROOT / "data" / "frontier_moe_verifier_hardneg_r18.json"
            elif 'r17' in hp:
                out_path = ROOT / "data" / "frontier_moe_verifier_hardneg_r17.json"
            elif 'r16' in hp:
                out_path = ROOT / "data" / "frontier_moe_verifier_hardneg_r16.json"
            elif 'r15' in hp:
